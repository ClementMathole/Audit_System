      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => Get.to(() => const SkillForm()),
          ),
        ],
      ),
            ...
            children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: const [
                            ...
                            SizedBox(height: 6),
                            Text(
                              "Tap on a skill to view details or edit.",
                              style: TextStyle(
              ...
              StreamBuilder<QuerySnapshot>(
                ...
                builder: (context, snapshot) {
                  ...
                  if (docs.isEmpty) {
                    // Purpose: Show a message when no skills are found
                    return const Center(child: Text("No skills submitted."));
                  }
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return InkWell(
                        ...
                        onTap: () {
                          Get.to(
                            () =>
                                SkillDetails(docId: docs[index].id, data: data),
                          );
                        },
                        child: Card(
                          elevation: 0,
